...
public class EmployeesUpdateServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(_token != null && _token.equals(request.getSession().getId())) {
            ...
            Employee e = em.find(Employee.class, (Integer)(request.getSession().getAttribute("employee_id"))); //セッションスコープからIDを取り出し、それを利用してデータを一件習得
            ...
            if(password == null || password.equals("")) {
                ...
                e.setPassword(
                        EncryptUtil.getPasswordEncrypt(
                                password,
                                (String)this.getServletContext().getAttribute("pepper") //パスワードのハッシュ化
                                )
                        );
            }
